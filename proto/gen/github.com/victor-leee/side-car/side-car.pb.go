...
type Header_RPCMessageReceiverType int32

const (
	// CONFIG_CENTER means the request would be routed to config kv cluster like ETCD
	Header_CONFIG_CENTER Header_RPCMessageReceiverType = 0
	// SIDE_CAR_PROXY means the request would be routed to another side-car proxy using route table
	Header_SIDE_CAR_PROXY Header_RPCMessageReceiverType = 1
)

// Enum value maps for Header_RPCMessageReceiverType.
var (
	Header_RPCMessageReceiverType_name = map[int32]string{
		0: "CONFIG_CENTER",
		1: "SIDE_CAR_PROXY",
	}
	Header_RPCMessageReceiverType_value = map[string]int32{
		"CONFIG_CENTER":  0,
		"SIDE_CAR_PROXY": 1,
	}
)

func (x Header_RPCMessageReceiverType) Enum() *Header_RPCMessageReceiverType {
	p := new(Header_RPCMessageReceiverType)
	*p = x
	return p
}

func (x Header_RPCMessageReceiverType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Header_RPCMessageReceiverType) Descriptor() protoreflect.EnumDescriptor {
	return file_side_car_proto_enumTypes[0].Descriptor()
}

func (Header_RPCMessageReceiverType) Type() protoreflect.EnumType {
	return &file_side_car_proto_enumTypes[0]
}

func (x Header_RPCMessageReceiverType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Header_RPCMessageReceiverType.Descriptor instead.
func (Header_RPCMessageReceiverType) EnumDescriptor() ([]byte, []int) {
...
type Header struct {
	...
	ReceiverType Header_RPCMessageReceiverType `protobuf:"varint,2,opt,name=receiver_type,json=receiverType,proto3,enum=com.github.victor_leee.side_car.Header_RPCMessageReceiverType" json:"receiver_type,omitempty"`
...
func (x *Header) GetReceiverType() Header_RPCMessageReceiverType {
	if x != nil {
...
var file_side_car_proto_rawDesc = []byte{
	...
	,
	...
	0x02, 0x38, 0x01, 0x22, 0x3f, 0x0a, 0x16, 0x52, 0x50, 0x43, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x11, 0x0a,
	...
	0x58, 0x59, 0x10, 0x01, 0x22, 0x31, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x52, 0x65, 0x71, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x69, 0x63, 0x74, 0x6f, 0x72, 0x2d, 0x6c, 0x65, 0x65,
	0x65, 0x2f, 0x73, 0x69, 0x64, 0x65, 0x2d, 0x63, 0x61, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_side_car_proto_goTypes = []interface{}{
	(Header_RPCMessageReceiverType)(0), // 0: com.github.victor_leee.side_car.Header.RPCMessageReceiverType
	(*Header)(nil),                     // 1: com.github.victor_leee.side_car.Header
	(*GetConfigReq)(nil),               // 2: com.github.victor_leee.side_car.GetConfigReq
	nil,                                // 3: com.github.victor_leee.side_car.Header.ExtraEntry
}
var file_side_car_proto_depIdxs = []int32{
	0, // 0: com.github.victor_leee.side_car.Header.receiver_type:type_name -> com.github.victor_leee.side_car.Header.RPCMessageReceiverType
	3, // 1: com.github.victor_leee.side_car.Header.extra:type_name -> com.github.victor_leee.side_car.Header.ExtraEntry
